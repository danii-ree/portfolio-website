...
;
;
/*#__NO_SIDE_EFFECTS__*/ var createUnitType = function createUnitType(unit) {
    return {
        test: function test(v) {
...
function buildTransformer(param) {
    var split = param.split, types = param.types;
 ...
 */ var convertToZero = function convertToZero(value, splitBefore) {
...
function getAnimatableNone(v) {
    var info = analyseComplexValue(v);
    var transformer = buildTransformer(info);
    return transformer(info.values.map(function(value, i) {
        return convertToZero(value, info.split[i]);
    }));
}
var complex = {
    test: test,
...
var matrix2dParsers = {
    ...
    skewY: function skewY(v) {
        return radToDeg(Math.atan(v[2]));
    },
    skew: function skew(v) {
        return (Math.abs(v[1]) + Math.abs(v[2])) / 2;
    }
};
var rebaseAngle = function rebaseAngle(angle) {
    angle = angle % 360;
    if (angle < 0) angle += 360;
    return angle;
};
var rotateZ = rotate;
var scaleX = function scaleX(v) {
    return Math.sqrt(v[0] * v[0] + v[1] * v[1]);
};
var scaleY = function scaleY(v) {
...
var matrix3dParsers = {
    ...
    rotateX: function rotateX(v) {
        return rebaseAngle(radToDeg(Math.atan2(v[6], v[5])));
    },
    rotateY: function rotateY(v) {
...
var readTransformValue = function readTransformValue(instance, name) {
...
var positionalValues = {
    // Dimensions
    width: function width(param, param1) {
        var x = param.x, _param_paddingLeft = param1.paddingLeft, paddingLeft = _param_paddingLeft === void 0 ? "0" : _param_paddingLeft, _param_paddingRight = param1.paddingRight, paddingRight = _param_paddingRight === void 0 ? "0" : _param_paddingRight, boxSizing = param1.boxSizing;
        var width = x.max - x.min;
        return boxSizing === "border-box" ? width : width - parseFloat(paddingLeft) - parseFloat(paddingRight);
    },
    height: function height(param, param1) {
        var y = param.y, _param_paddingTop = param1.paddingTop, paddingTop = _param_paddingTop === void 0 ? "0" : _param_paddingTop, _param_paddingBottom = param1.paddingBottom, paddingBottom = _param_paddingBottom === void 0 ? "0" : _param_paddingBottom, boxSizing = param1.boxSizing;
        var height = y.max - y.min;
        return boxSizing === "border-box" ? height : height - parseFloat(paddingTop) - parseFloat(paddingBottom);
    },
    top: function top(_bbox, param) {
        var top = param.top;
        return parseFloat(top);
    },
    left: function left(_bbox, param) {
        var left = param.left;
        return parseFloat(left);
    },
    bottom: function bottom(param, param1) {
        var y = param.y, top = param1.top;
        return parseFloat(top) + (y.max - y.min);
    },
    right: function right(param, param1) {
        var x = param.x, left = param1.left;
        return parseFloat(left) + (x.max - x.min);
    },
    // Transform
    x: function x(_bbox, param) {
...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
    ...
    var processBatch = function processBatch1() {
        var useManualTiming = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$utils$2f$dist$2f$es$2f$global$2d$config$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MotionGlobalConfig"].useManualTiming;
        var timestamp = useManualTiming ? state.timestamp : performance.now();
        runNextFrame = false;
        if (!useManualTiming) {
...
var supportsViewTimeline = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$utils$2f$supports$2f$memo$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memoSupports"])(function() {
    return window.ViewTimeline !== undefined;
}, "viewTimeline");
;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@swc/helpers/esm/_sliced_to_array.js [app-client] (ecmascript)");
;
var cubicBezierAsString = function cubicBezierAsString(param) {
 ...
 */ var NativeAnimation = /*#__PURE__*/ function(WithPromise) {
     ...
     */ key: "commitStyles",
        ...
        },
        {
            ...
            set: function set(newTime) {
                var wasFinished = this.finishedTime !== null;
                this.manualStartTime = null;
     ...
     */ key: "attachTimeline",
            value: function attachTimeline(param) {
                var timeline = param.timeline, rangeStart = param.rangeStart, rangeEnd = param.rangeEnd, observe = param.observe;
...
*/ var mixNumber = function mixNumber(from, to, progress) {
...
var correctBoxShadow = {
    correct: function correct(latest, param) {
 ...
 */ function transformBox(box, transform, sourceBox) {
    var resolveBox = sourceBox !== null && sourceBox !== void 0 ? sourceBox : box;
...
var frameloopDriver = function frameloopDriver(update) {
    var passTimestamp = function passTimestamp(param) {
...
function getSpringOptions(options) {
    ...
    if (!isSpringType(options, physicsKeys) && isSpringType(options, durationKeys)) {
        ...
        if (options.visualDuration) {
            ...
            var derived = findSpring((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_object_spread_props$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_object_spread$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({}, options), {
                velocity: 0
            }));
            springOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_object_spread_props$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_object_spread$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({}, springOptions, derived), {
                mass: springDefaults.mass
...
function spring() {
    ...
    if (dampingRatio < 1) {
        ...
        var C = initialVelocity + undampedAngularFreq * initialDelta;
        resolveVelocity = function resolveVelocity(t) {
            return Math.exp(-undampedAngularFreq * t) * (undampedAngularFreq * C * t - initialVelocity);
        };
    } else {
        // Overdamped spring
        ...
        var P = (initialVelocity + dampingRatio * undampedAngularFreq * initialDelta) / dampedAngularFreq;
        var sinhCoeff = dampingRatio * undampedAngularFreq * P - initialDelta * dampedAngularFreq;
        var coshCoeff = dampingRatio * undampedAngularFreq * initialDelta - P * dampedAngularFreq;
        resolveVelocity = function resolveVelocity(t) {
            var envelope = Math.exp(-dampingRatio * undampedAngularFreq * t);
            var freqForT = Math.min(dampedAngularFreq * t, 300);
    ...
    var generator = {
        ...
        velocity: function velocity(t) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$utils$2f$dist$2f$es$2f$time$2d$conversion$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secondsToMilliseconds"])(resolveVelocity(t));
        },
        next: function next(t) {
             ...
             */ if (!isResolvedFromDuration && dampingRatio < 1) {
                var envelope = Math.exp(-dampingRatio * undampedAngularFreq * t);
                var sin = Math.sin(angularFreq * t);
                var cos = Math.cos(angularFreq * t);
                var current = target - envelope * (A * sin + initialDelta * cos);
                var currentVelocity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$utils$2f$dist$2f$es$2f$time$2d$conversion$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secondsToMilliseconds"])(envelope * (sinCoeff * sin + cosCoeff * cos));
                state.done = Math.abs(currentVelocity) <= restSpeed && Math.abs(target - current) <= restDelta;
                state.value = state.done ? target : current;
                return state;
            }
            var current1 = resolveSpring(t);
            if (!isResolvedFromDuration) {
                var currentVelocity1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$utils$2f$dist$2f$es$2f$time$2d$conversion$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secondsToMilliseconds"])(resolveVelocity(t));
                state.done = Math.abs(currentVelocity1) <= restSpeed && Math.abs(target - current1) <= restDelta;
            } else {
                state.done = t >= duration;
            }
            state.value = state.done ? target : current1;
            return state;
        },
        ...
        toTransition: function toTransition() {}
    };
    return generator;
}
...
var JSAnimation = /*#__PURE__*/ function(WithPromise) {
     ...
     */ key: "getGeneratorVelocity",
            value: function getGeneratorVelocity() {
                var _this = this;
                ...
                var current = this.generator.next(t).value;
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$animation$2f$generators$2f$utils$2f$velocity$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGeneratorVelocity"])(function(s) {
                    return _this.generator.next(s).value;
                }, t, current);
            }
        },
        {
...
var NativeAnimationExtended = /*#__PURE__*/ function(NativeAnimation) {
     ...
     */ key: "updateMotionValue",
         ...
         */ var sampleTime = Math.max(sampleDelta, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$frameloop$2f$sync$2d$time$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["time"].now() - this.startTime);
                ...
                var current = sampleAnimation.sample(sampleTime).value;
                /**
...
function supportsBrowserAnimation(options) {
    ...
    var motionValue = options.motionValue, name = options.name, repeatDelay = options.repeatDelay, repeatType = options.repeatType, damping = options.damping, type = options.type, keyframes = options.keyframes;
...
var AsyncMotionValueAnimation = /*#__PURE__*/ function(WithPromise) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_create_class$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(AsyncMotionValueAnimation, [
         ...
         */ var useWaapi = canAnimateValue && !isHandoff && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$animation$2f$waapi$2f$supports$2f$waapi$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supportsBrowserAnimation"])(resolvedOptions);
...
var getDefaultTransition = function getDefaultTransition(valueKey, param) {
...
var animateMotionValue = function animateMotionValue(name, value, target) {
     ...
     */ if (shouldSkip && !isHandoff && value.get() !== undefined) {
            var finalKeyframe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$animation$2f$keyframes$2f$get$2d$final$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFinalKeyframe"])(options.keyframes, valueTransition);
...
function animateTarget(visualElement, targetAndTransition) {
    ...
    if (transitionEnd) {
        var applyTransitionEnd = function applyTransitionEnd() {
...
var observer;
var getSize = function getSize(borderBoxAxis, svgAxis, htmlAxis) {
 ...
 */ function delay(callback, timeout) {
    ...
    var checkElapsed = function checkElapsed1(param) {
        var timestamp = param.timestamp;
...
function mixValues(target, follow, lead, progress, shouldCrossfadeOpacity, isOnlyMember) {
     ...
     */ for(var i = 0; i < numBorders; i++){
        var borderLabel = borderLabels[i];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_create_class$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(NodeStack, [
        ...
        },
        {
            ...
            value: function relegate(node) {
                for(var i = this.members.indexOf(node) - 1; i >= 0; i--){
        ...
        },
        {
            ...
            value: function promote(node, preserveFollowOpacity) {
                ...
                if (prevLead) {
                    ...
                    node.scheduleRender();
                    var _prevLead_options = prevLead.options, prevDep = _prevLead_options.layoutDependency;
                    var _node_options = node.options, nextDep = _node_options.layoutDependency;
        ...
        },
        {
            ...
            value: function scheduleRender() {
                this.members.forEach(function(member) {
                    return member.instance && member.scheduleRender(false);
                });
            }
        },
        {
         ...
         */ key: "updateSnapshot",
            ...
            },
            {
                ...
                value: function applyTransform(box) {
                    var transformOnly = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, output = arguments.length > 2 ? arguments[2] : void 0;
                    var withTransforms = output || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$projection$2f$geometry$2f$models$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBox"])();
...
function notifyLayoutUpdate(node) {
    ...
    if (node.isLead() && node.layout && snapshot && node.hasListeners("didUpdate")) {
        ...
        if (animationType === "size") {
            ...
            var snapAxis = animationType === "x" ? "y" : "x";
 ...
 */ function hover(elementOrSelector, onHoverStart) {
    ...
    elements.forEach(function(element) {
        ...
        var removePointerLeave = function removePointerLeave() {
            element.removeEventListener("pointerleave", onPointerLeave);
        };
        var endHover = function endHover(event) {
            if (hoverEndCallback) {
        ...
        var onPointerUp = function onPointerUp1(event) {
            isPressed = false;
        ...
        var onPointerLeave = function onPointerLeave(leaveEvent) {
        ...
        var onPointerEnter = function onPointerEnter(enterEvent) {
 ...
 */ var isNodeOrChild = function isNodeOrChild1(parent, child) {
    if (!child) {
        return false;
